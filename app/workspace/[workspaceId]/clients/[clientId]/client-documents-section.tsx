...
import { deleteClientDocumentAction } from "../actions";
...
function isImageDocument(doc: ClientDocument): boolean {
...
export function ClientDocumentsSection({
  ...
  const { startUpload, isUploading } = useUploadThing("clientMedia", {
    onUploadError: (err) => {
  ...
  function deleteDocument(documentId: string) {
    ...
    startTransition(async () => {
      const result = await deleteClientDocumentAction(
        workspaceId,
        clientId,
        documentId,
      );
